...
- question: Les raccords PEX - comment les installer ?
  answer: La méthode d'installation des raccords de tuyauterie PEX dépend de leur
    construction. Avant de commencer le processus d'installation, vous devez vous
    assurer du type de raccord que vous possédez et suivre les instructions du fabricant.
- question: Comment mesurer les raccords de tuyauterie ?
  answer: La mesure des tuyaux et des accessoires de tuyauterie dépend du type de
    filetage. Pour les filetages mâles, mesurez le diamètre extérieur. Pour les filetages
    femelles, vous devez mesurer le diamètre intérieur.
- question: Comment faire suer les raccords en cuivre ?
  answer: Commencez par nettoyer le métal et appliquez une pâte de flux. Posez le
    raccord sur le tuyau et chauffez le joint pour que la pâte fond et fixe le raccord.
- question: Comment retirer les raccords pex ?
  answer: La façon la plus simple de retirer les raccords de tuyaux PEX est d'utiliser
    un outil spécial de retrait. Utilisez-le pour couper la bague de sertissage. De
    nombreux types de raccords, par exemple les raccords en cuivre, peuvent être réutilisés
